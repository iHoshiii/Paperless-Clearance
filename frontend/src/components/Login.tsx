            ...
            <>
              ...
              <div className="form-group">
                ...
                <select id="role" name="role" value={formData.role} onChange={handleInputChange} required>
                  ...
                  <option value="mother_organization">Mother Organization</option>
              ...
              <div className="form-group">
                ...
                <input type="tel" id="contactNumber" name="contactNumber" value={formData.contactNumber} onChange={handleInputChange} />
              </div>
            </>
          )}
